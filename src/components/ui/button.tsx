  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "luxury-gradient text-primary-foreground hover:scale-105 hover-glow font-medium tracking-wide",
        premium: "bg-luxury-charcoal border border-luxury-gold text-luxury-gold hover:bg-luxury-gold hover:text-luxury-charcoal hover-glow",
        hero: "glass border border-luxury-gold/30 text-foreground hover:bg-luxury-gold/10 hover:border-luxury-gold/60 backdrop-blur-md",
      },
      size: {
